...
public class MainActivity extends Activity {
    ...
    void build(){
        ...
        subtitle=label("v13.0 Play Store Polish Edition • 5 languages • Immersive fullscreen",14,Color.WHITE,false);
    ...
    void showHome(){
        clear("World Cup Fan 2026","v13.0 • "+lang+" • Global fan app","Home");
...
LinearLayout hero=card(); hero.setBackground(gradient(RED_DARK,RED,dp(24)));
        hero.addView(label("🌍 GLOBAL EDITION v13.0",24,Color.WHITE,true));
...
Button mode=btn(darkMode?tr("Switch to Light Mode"):tr("Switch to Dark Mode"));
        ...
        LinearLayout l=card();
        l.addView(label("Version 13.0 Build Verified",22,RED,false));
